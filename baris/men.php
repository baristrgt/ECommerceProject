...
<body class="animsition">
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            echo '<div class="col-sm-6 col-md-12 col-lg-3 p-b-35 isotope-item women">';
            echo '<div class="block2">';
            echo '<div class="block2-pic hov-img0">';
            echo '<div class="product">';
            echo '<img src="' . $row["product_img"] . '">';
            echo '<a href="shoping-cart.php">';
            echo "<br><br>";
    ...
    ?>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women"></div>
                            ...
                            <div class="p-t-33">
                                ...
                                <div class="flex-w flex-r-m p-b-10">
                                    <div class="size-204 flex-w flex-m respon6-next">
                                        ...
                                        <button id="add-to-cart-btn" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" href="shoping-cart.php">
                                            Add to cart
                                        </button>
                                    </div>
                                </div>  
