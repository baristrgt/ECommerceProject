		...
		<div class="container">
			<div class="flex-w flex-tr justify-content-center">
				<div class="size-210 bor10 flex-w flex-col-m p-lr-93 p-tb-30 p-lr-15-lg w-full-md">
					<div class="flex-w w-full p-b-42 align-items-center justify-content-center">
						<div class="text-center w-100">
							<span class="fs-18 cl5 d-block mb-3">
								<span class="lnr lnr-map-marker"></span>
							</span>
							<span class="mtext-110 cl2 d-block">
								Address
							</span>
					...
					<div class="flex-w w-full align-items-center justify-content-center">
						<div class="text-center w-100">
							<span class="fs-18 cl5 d-block mb-3">
